...
class  PharmaCoNERRunner:
    ...
    def __init__(self, pharmaconer_path,model_name, output_path, parameters_path, ok_status_code='Data retrieved successfully.',
                 id_length=10,
                 clean_files=True):
        ...
        self.pretrained_model_folder = os.path.join( '/app/trained_models', model_name)
